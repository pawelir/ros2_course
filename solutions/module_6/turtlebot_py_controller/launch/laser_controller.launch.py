...
def generate_launch_description():
    ...
    locator = Node(
        package='turtlebot_py_controller', executable='obstacle_locator',
        name='obstacle_locator', output='screen',
    ...
    return LaunchDescription([use_sim, gui, use_rviz, stop_distance, simulation, controller, locator, rviz])
